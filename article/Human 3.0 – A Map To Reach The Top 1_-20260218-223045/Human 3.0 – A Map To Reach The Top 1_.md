...
> Note: I have created a HUMAN 3.0 Knowledge Base with nuances of the model, civilizational impact, historical context, scientific foundations, and my personal principles weaved in. If you want a comprehensive and skimmable breakdown of the entirety of the model,
> 
> [read it here](https://letters.thedankoe.com/p/a-complete-knowledge-base-of-human)
> 
> or paste it into AI to explore it. I’ll also link it at the end (I’d recommend reading this first).
...
to help you map your own development, find your Metatype, and identify the next core problem to solve in your life. I will include a link to it below as well. I would recommend reading this article first so you understand what’s going on.
...
if you want these articles sent directly to you, just in case the algorithm doesn't show you them.
...
I created a prompt to identify your Metatype, map your development across all quadrants, and

[find the core problem in your life here.](https://letters.thedankoe.com/p/prompt-human-30-self-discovery-and)
...
> Ken Wilber's "pre-trans fallacy" occurs when people confuse pre-rational (Conformist) states with trans-rational (Synthesist) states because both appear "non-rational" from a conventional rational (Individualist) perspective. This can happen both
> 
> [ways.One](https://ways.one/)
> 
> can elevate a Level 1 primitive state to Level 3 status, and some often reduce genuine Level 3 development to being primitive
> 
> [thinking.In](https://thinking.in/)
> 
> other words, a "bible thumper" with lack of knowledge and experience beyond their childhood conditioning finds it difficult to take a mystic seriously, when the mystic often holds the same truths, but from a more comprehensive perspective.If it helps, think of the
> 
> [IQ bell curve meme](https://knowyourmeme.com/memes/iq-bell-curve-midwit)
> 
> .
...
https://x.com/thedankoe/status/2023779299367809063
